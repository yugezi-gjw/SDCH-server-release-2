package com.varian.oiscn.carepath.util;
...
public class MockDtoUtil {
    ...
    public static PatientDto givenAPatient() {
        ...
        patientDto.setPatientSer("patientSer");
...
//        encounter.setPatientSourceEnum(PatientSourceEnum.E);
    ...
    public static CarePathTemplate givenCarePathTemplate() {
        ...
        PlannedActivity activity5 = new PlannedActivity();
        activity5.setId("5");
        activity5.setDepartmentID("1");
        activity5.setDefaultGroupID(DEFAULT_GROUPID);
        activity5.setActivityType(ActivityTypeEnum.APPOINTMENT);
        activity5.setActivityCode("DoCT");
        activity5.setPrevActivities(Arrays.asList("4"));
        activity5.setNextActivities(null);
        ...
        template.addPlannedActivity(activity5);
        return template;
    }
