...
public class IAuthorizationValidateTokenServiceFaultFaultFaultMessage
        extends Exception {
     ...
     * @param message
     */
    public IAuthorizationValidateTokenServiceFaultFaultFaultMessage(String message, ServiceFault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public IAuthorizationValidateTokenServiceFaultFaultFaultMessage(String message, ServiceFault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
