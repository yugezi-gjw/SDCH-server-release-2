package com.varian.oiscn.encounter.util;
...
//        encounter.setPatientSourceEnum(PatientSourceEnum.E);
        ...
        encounter.setPhysicianComment("comments");
        encounter.setAllergyInfo("allergyInfo");
        encounter.setEncounterCarePathList(givenEncounterCarePathList());
        return encounter;
    }
    ...
    public static List<EncounterCarePath> givenEncounterCarePathList() {
        List<EncounterCarePath> paths = new ArrayList<>();
        EncounterCarePath encounterCarePath = new EncounterCarePath();
        encounterCarePath.setEncounterId(123l);
        encounterCarePath.setCpInstanceId(12l);
        paths.add(encounterCarePath);
        return paths;
    }
    ...
    public static PhysicianCommentDto givenAPhysicianCommentDto() {
        ...
        dto.setPatientSer("1212");
        return dto;
    }

    public static SetupPhotoDTO givenASetupPhoto() {
        SetupPhotoDTO dto = new SetupPhotoDTO();
        dto.setDeviceId("testDeviceId");
        dto.setPatientSer(123456L);
        dto.setId("testId");
        return dto;
    }

    public static SetupPhotoDetailDTO givenASetupPhotoDetail() {
        SetupPhotoDetailDTO dto = new SetupPhotoDetailDTO();
        dto.setPhotoId("testPhotoId");
        dto.setPhoto("asdfasdfadsasdf");
        return dto;
    }

    public static SetupPhotoDTO assembleSetupPhotoDTO() {
        SetupPhotoDTO dto = new SetupPhotoDTO();
        dto.setPatientSer(123456L);
        dto.setDeviceId("deviceId");
        dto.setPhotos(assembleSetupPhotoDetails());
        return dto;
    }

    public static List<SetupPhotoDetailDTO> assembleSetupPhotoDetails() {
        List<SetupPhotoDetailDTO> details = new ArrayList<>();
        SetupPhotoDetailDTO detail1 = new SetupPhotoDetailDTO();
        detail1.setPhotoId("photoId1");
        detail1.setPhoto("asdfasdfadsasdf");
        SetupPhotoDetailDTO detail2 = new SetupPhotoDetailDTO();
        detail2.setPhotoId("photoId2");
        detail2.setPhoto("asdfasdfadsasdf");
        details.add(detail1);
        details.add(detail2);
        return details;
    }

    public static List<SetupPhotoArchiveDTO> assembleSetupPhotoArchives() {
        List<SetupPhotoArchiveDTO> dtos = new ArrayList<>();
        SetupPhotoArchiveDTO dto = new SetupPhotoArchiveDTO();
        dto.setPhotoId("photoId");
        dto.setPhoto("asdfasdfadsasdf");
        dto.setDynamicFormRecordId(1);
        dtos.add(dto);
        return dtos;
    }
