...
@PrepareForTest({HISOnlyScenario.class, PatientRegistryAssembler.class,
        ...
        RegistryUtil.class})
public class HISOnlyScenarioTest {
    ...
    private HISOnlyScenario registry;
    ...
    public void testPatientSerIsNull() {
        ...
        registry = new HISOnlyScenario(patient, encounter, null);
