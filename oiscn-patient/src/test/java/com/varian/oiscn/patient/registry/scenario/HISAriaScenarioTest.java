...
@PrepareForTest({HISAriaScenario.class, PatientRegistryAssembler.class,
...
public class HISAriaScenarioTest {
    ...
    private HISAriaScenario registry;
    ...
    public void setup() throws Exception {
        ...
        PowerMockito.when(coverageAntiCorruptionServiceImp.updateCoverage(anyObject())).thenReturn("id");
    ...
    public void testPatientSerIsNull() {
        registry = new HISAriaScenario(new Patient(), new Encounter());
    ...
    public void testSaveOrUpdate() {
        ...
        registry = new HISAriaScenario(patient, encounter);
